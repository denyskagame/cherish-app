...
export const adminEn = {
  ...
  "btn.clearTables": "Clear tables",
  "btn.draw": "Draw",
  "btn.clearDrawings": "Clear drawing",
  "help.drawMode": "Drag in the room to draw a shape — it smooths as you go. Tap a shape to remove it.",
  "confirm.clearAll": "Delete all {n} tables?",
  "common.yes": "Yes",
  "common.no": "No",
  "insp.seatMapTitle": "Seat map",
  "insp.tableSize": "Table size",
...
export const adminFr: Record<AdminKey, string> = {
  ...
  "btn.clearTables": "Vider les tables",
  "btn.draw": "Dessiner",
  "btn.clearDrawings": "Effacer le dessin",
  "help.drawMode": "Glissez dans la salle pour dessiner une forme — elle se lisse automatiquement. Touchez une forme pour la retirer.",
  "confirm.clearAll": "Supprimer les {n} tables ?",
  "common.yes": "Oui",
  "common.no": "Non",
  "insp.seatMapTitle": "Plan des places",
  "insp.tableSize": "Taille de la table",
